...
public class Gramatica {
    ...
    public Gramatica() {
        ...
        listRegras.put(3, new String[]{"55", "47"});
        listRegras.put(4, new String[]{" "});
        listRegras.put(5, new String[]{"46", "25", "56"});
        listRegras.put(6, new String[]{"3", "25", "40", "26", "47", "58"});
        listRegras.put(7, new String[]{"25", "40", "26", "47", "58"});
        listRegras.put(8, new String[]{"4", "55", "39", "61", "47", "60"});
        listRegras.put(9, new String[]{"25", "56"});
